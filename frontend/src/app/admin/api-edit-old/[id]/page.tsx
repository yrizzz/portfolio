...
import { Save, ArrowLeft, Play, AlertCircle, CheckCircle2, XCircle, Sparkles, Plus, Trash2, FileText, Copy, Check } from 'lucide-react';
...
export default function EditAPIPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleTestCode = async () => {
    ...
    try {
      ...
      console.log('[Test Code] Sending request to sandbox...');
      console.log('[Test Code] Test params:', testParams);
      ...
      console.log('[Test Code] Response status:', response.status);
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    {testResult.result?.output && (
                      <div>
                        ...
                        <div className="bg-background/80 p-3 rounded-lg border overflow-auto max-h-[600px]">
