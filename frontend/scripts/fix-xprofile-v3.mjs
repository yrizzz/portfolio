...
// Use single quotes for the cookie to avoid escaping issues
const xprofileCode = `
...
module.exports = async ({ username }) => {
    try {
      ...
      const cookieString = 'guest_id_marketing=v1%3A176518126492800702; guest_id_ads=v1%3A176518126492800702; guest_id=v1%3A176518126492800702; d_prefs=MjoxLGNvbnNlbnRfdmVyc2lvbjoyLHRleHRfdmVyc2lvbjoxMDAw; __cuid=78619a9c484b46a5abd2fe5ccd2b09df; personalization_id=v1_G6EgcXXv4Os9wcbPmuCnZQ; kdt=iJlCKDoSogJn1qy1sypC6bLoSax8x7dACj4HfVbS; auth_token=a6f4a18741b5393c57fc30e9557e8efd0842fad9; ct0=fb228f66bfc778d8adc247a2361b7d21f874300e188c6064dfd562056cdbe9b7732753c7bd3298de4c07d915ec4af68e85ecd1c12f465f3e34a9c2638cdbca06f91bdcbe5e27fb11f82e732f1ac4e12d; twid=u%3D1192069840355262469; lang=en';
...
async function fixXProfile() {
  console.log('🔧 Fixing xprofile API (removing problematic JSON in Cookie)...\n');
  ...
  try {
    ...
    console.log('✅ Fixed xprofile API - removed JSON objects from Cookie string');
