...
// Instagram Profile - PURE global headers (no defaults)
...
// Instagram Highlight - PURE global headers (no defaults)
...
async function updateInstagramApis() {
  try {
    ...
    console.log('📋 Updating Instagram APIs to use PURE global headers...\n');
    
    const updates = [
      { 
        name: 'igprofile', 
        code: instagramProfileCode,
        description: 'Instagram Profile - PURE global headers (no defaults)'
      },
      { 
        name: 'ighighlight', 
        code: instagramHighlightCode,
        description: 'Instagram Highlight - PURE global headers (no defaults)'
      },
    ];
